...
2. Wait for an automatic binding update to run, which is scheduled every 2 weeks. This automatic
   binding update will update bindings for both API and Identity.
