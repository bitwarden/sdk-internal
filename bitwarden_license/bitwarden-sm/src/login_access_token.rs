...
use crate::{
    AccessToken,
    access_token::AccessTokenInvalidError,
    access_token_request::AccessTokenRequest,
    client::SecretsManagerClient,
    login_types::{AccessTokenLoginRequest, AccessTokenLoginResponse},
...
pub(crate) async fn login_access_token(
    ...
    let access_token: AccessToken = input
        .access_token
        .parse()
        .map_err(|e: AccessTokenInvalidError| LoginError::AccessTokenInvalid(e.to_string()))?;
