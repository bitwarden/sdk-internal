...
use bitwarden_crypto::{
    ...
    AsymmetricCryptoKey, SignatureAlgorithm, SigningKey, SymmetricCryptoKey, UnsignedSharedKey, UserKey,
};
...
pub(super) fn verify_asymmetric_keys(
    ...
    fn verify_inner(
        ...
        let private_key =
            AsymmetricCryptoKey::from_der(&decrypted_private_key).map_err(VerifyError::ParseFailed)?;
...
mod tests {
    ...
    fn test_enroll_admin_password_reset() {
        ...
        let private_key = AsymmetricCryptoKey::from_der(&STANDARD.decode(private_key).unwrap()).unwrap();
