...
mod tests {
    ...
    fn test_enroll_admin_password_reset() {
        ...
        let decrypted: Vec<u8> = encrypted.decrypt_with_key(&private_key, &NoContextBuilder).unwrap();
    ...
    fn test_make_key_pair() {
        ...
        let private_key: Vec<u8> = encrypted_private_key.decrypt_with_key(&user_key.0, &NoContextBuilder).unwrap();
