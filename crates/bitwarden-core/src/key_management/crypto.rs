...
mod tests {
    ...
    async fn test_make_user_tde_registration() {
        ...
        let registration_client = Client::new_test();
        ...
        let unlock_client = Client::new_test();
        unlock_client
            .crypto()
