...
threat model, and the open questions — lives in [`Spec.md`](./Spec.md). That spec is a **draft**:
several load-bearing questions (epoch-head equivocation, inner-message confidentiality, genesis-key
trust) are unresolved.
