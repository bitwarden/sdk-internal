...
- Server Git commit:
  [`69d020730a96e1481e3efff62260d747002315de`](https://github.com/bitwarden/server/commit/69d020730a96e1481e3efff62260d747002315de)
...
| _OrganizationReportsApi_                  | [**create_organization_report**](docs/OrganizationReportsApi.md#organization_reports_create_organization_report)                                                 | **POST** /reports/organizations/{organizationId}                                                         | Creates a new organization report for the specified organization. When the Access Intelligence V2 feature flag is enabled, validates the file size and returns a presigned upload URL for the report file along with the created report metadata. Otherwise, creates the report with inline data.                                                                                                                                                                                                                               |
...
| _OrganizationReportsApi_                  | [**upload_report_file**](docs/OrganizationReportsApi.md#organization_reports_upload_report_file)                                                                 | **POST** /reports/organizations/{organizationId}/{reportId}/file                                         | Uploads a report data file for a self-hosted organization report via multipart form data. Validates the uploaded file size against the expected size (with a 1 MB leeway) and marks the report file as validated upon success. Requires the Access Intelligence V2 feature flag.                                                                                                                                                                                                                                                |
