...
pub struct RotateUserKeysRequestModel {
    #[serde(rename = "wrappedAccountCryptographicState", alias = "WrappedAccountCryptographicState")]
    pub wrapped_account_cryptographic_state: Box<models::WrappedAccountCryptographicStateRequestModel>,
...
impl RotateUserKeysRequestModel {
    pub fn new(wrapped_account_cryptographic_state: models::WrappedAccountCryptographicStateRequestModel, unlock_data: models::CommonUnlockDataRequestModel, account_data: models::AccountDataRequestModel, unlock_method_data: models::UnlockMethodRequestModel) -> RotateUserKeysRequestModel {
