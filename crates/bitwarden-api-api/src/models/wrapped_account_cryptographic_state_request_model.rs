...
impl WrappedAccountCryptographicStateRequestModel {
    pub fn new(public_key_encryption_key_pair: models::PublicKeyEncryptionKeyPairRequestModel, signature_key_pair: models::SignatureKeyPairRequestModel, security_state: models::SecurityStateModel) -> WrappedAccountCryptographicStateRequestModel {
