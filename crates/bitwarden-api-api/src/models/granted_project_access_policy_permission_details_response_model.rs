...
pub struct GrantedProjectAccessPolicyPermissionDetailsResponseModel {
    ...
    #[serde(rename = "accessPolicy", alias = "AccessPolicy", skip_serializing_if = "Option::is_none")]
    pub access_policy: Option<Box<models::GrantedProjectAccessPolicyResponseModel>>,
    #[serde(rename = "hasPermission", alias = "HasPermission", skip_serializing_if = "Option::is_none")]
