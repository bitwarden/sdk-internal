...
pub struct OrganizationUserBulkConfirmRequestModel {
    ...
    #[serde(rename = "defaultUserCollectionName", alias = "DefaultUserCollectionName", skip_serializing_if = "Option::is_none")]
    pub default_user_collection_name: Option<String>,
}

impl OrganizationUserBulkConfirmRequestModel {
    pub fn new(keys: Vec<models::OrganizationUserBulkConfirmRequestModelEntry>) -> OrganizationUserBulkConfirmRequestModel {
