...
pub struct SecretsManagerSubscribeRequestModel {
    ...
    #[serde(rename = "additionalServiceAccounts", alias = "AdditionalServiceAccounts")]
    pub additional_service_accounts: i32,
}

impl SecretsManagerSubscribeRequestModel {
    pub fn new(additional_sm_seats: i32, additional_service_accounts: i32) -> SecretsManagerSubscribeRequestModel {
