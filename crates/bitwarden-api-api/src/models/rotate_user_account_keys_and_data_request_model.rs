...
pub struct RotateUserAccountKeysAndDataRequestModel {
    #[serde(rename = "oldMasterKeyAuthenticationHash", alias = "OldMasterKeyAuthenticationHash")]
...
impl RotateUserAccountKeysAndDataRequestModel {
    pub fn new(old_master_key_authentication_hash: Option<String>, account_unlock_data: models::UnlockDataRequestModel, account_keys: models::AccountKeysRequestModel, account_data: models::AccountDataRequestModel) -> RotateUserAccountKeysAndDataRequestModel {
