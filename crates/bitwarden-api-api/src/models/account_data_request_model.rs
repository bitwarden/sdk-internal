...
impl AccountDataRequestModel {
    pub fn new(ciphers: Option<Vec<models::CipherWithIdRequestModel>>, folders: Option<Vec<models::FolderWithIdRequestModel>>, sends: Option<Vec<models::SendWithIdRequestModel>>) -> AccountDataRequestModel {
