...
pub struct PushRegistrationRequestModel {
    ...
    #[serde(rename = "organizationIds", alias = "OrganizationIds", skip_serializing_if = "Option::is_none")]
...
impl PushRegistrationRequestModel {
    pub fn new(device_id: String, push_token: String, user_id: String, r#type: models::DeviceType, identifier: String) -> PushRegistrationRequestModel {
