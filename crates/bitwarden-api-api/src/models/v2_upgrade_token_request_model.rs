...
/// V2UpgradeTokenRequestModel : Request model for V2 upgrade token submitted during key rotation. Contains wrapped user keys allowing clients to unlock after V1→V2 upgrade.
...
impl V2UpgradeTokenRequestModel {
    /// Request model for V2 upgrade token submitted during key rotation. Contains wrapped user keys allowing clients to unlock after V1→V2 upgrade.
