...
pub struct ServiceAccountGrantedPoliciesRequestModel {
    #[serde(rename = "projectGrantedPolicyRequests", alias = "ProjectGrantedPolicyRequests")]
...
impl ServiceAccountGrantedPoliciesRequestModel {
    pub fn new(project_granted_policy_requests: Option<Vec<models::GrantedAccessPolicyRequest>>) -> ServiceAccountGrantedPoliciesRequestModel {
