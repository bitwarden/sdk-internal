...
pub struct CreateOrganizationInviteLinkRequestModel {
    ...
    #[serde(rename = "encryptedOrgKey", alias = "EncryptedOrgKey", skip_serializing_if = "Option::is_none")]
    pub encrypted_org_key: Option<String>,
}

impl CreateOrganizationInviteLinkRequestModel {
    pub fn new(allowed_domains: Vec<String>, encrypted_invite_key: String) -> CreateOrganizationInviteLinkRequestModel {
