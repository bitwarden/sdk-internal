...
pub struct ProviderOrganizationCreateRequestModel {
    ...
    #[serde(rename = "organizationCreateRequest", alias = "OrganizationCreateRequest")]
    pub organization_create_request: Box<models::OrganizationCreateRequestModel>,
}

impl ProviderOrganizationCreateRequestModel {
    pub fn new(client_owner_email: String, organization_create_request: models::OrganizationCreateRequestModel) -> ProviderOrganizationCreateRequestModel {
