...
pub struct BillingCustomerDiscount {
    ...
    #[serde(rename = "active", alias = "Active", skip_serializing_if = "Option::is_none")]
    pub active: Option<bool>,
    /// Percentage discount applied to the subscription (e.g., 20.0 for 20% off). Null if this is an amount-based discount.
    #[serde(rename = "percentOff", alias = "PercentOff", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "amountOff", alias = "AmountOff", skip_serializing_if = "Option::is_none")]
    pub amount_off: Option<f64>,
    /// The instant the discount stops applying (Stripe Discount.end). Null = no end date / perpetual.
    ...
    #[serde(rename = "durationInMonths", alias = "DurationInMonths", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "appliesTo", alias = "AppliesTo", skip_serializing_if = "Option::is_none")]
