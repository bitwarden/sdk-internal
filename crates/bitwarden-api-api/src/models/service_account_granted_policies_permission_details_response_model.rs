...
pub struct ServiceAccountGrantedPoliciesPermissionDetailsResponseModel {
    ...
    #[serde(rename = "grantedProjectPolicies", alias = "GrantedProjectPolicies", skip_serializing_if = "Option::is_none")]
    pub granted_project_policies: Option<Vec<models::GrantedProjectAccessPolicyPermissionDetailsResponseModel>>,
}
