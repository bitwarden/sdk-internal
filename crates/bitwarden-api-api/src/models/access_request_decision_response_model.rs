...
pub struct AccessRequestDecisionResponseModel {
    #[serde(rename = "deciderKind", alias = "DeciderKind", skip_serializing_if = "Option::is_none")]
    pub decider_kind: Option<models::DeciderKind>,
    /// The human approver's user id, or null for an automatic decision.
    #[serde(rename = "id", alias = "Id", skip_serializing_if = "Option::is_none")]
    pub id: Option<uuid::Uuid>,
    /// The human approver's display name; null for an automatic decision, or when the user could not be resolved.
    #[serde(rename = "name", alias = "Name", skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    /// The human approver's email; null for an automatic decision, or when the user could not be resolved.
    ...
    #[serde(rename = "verdict", alias = "Verdict", skip_serializing_if = "Option::is_none")]
    pub verdict: Option<models::AccessDecisionVerdict>,
    /// When the decision was recorded (UTC).
    #[serde(rename = "decidedAt", alias = "DecidedAt", skip_serializing_if = "Option::is_none")]
