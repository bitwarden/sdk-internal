...
pub struct KeyRegenerationRequestModel {
    ...
    #[serde(rename = "userKeyEncryptedUserPrivateKey", alias = "UserKeyEncryptedUserPrivateKey")]
    pub user_key_encrypted_user_private_key: Option<String>,
}

impl KeyRegenerationRequestModel {
    pub fn new(user_public_key: Option<String>, user_key_encrypted_user_private_key: Option<String>) -> KeyRegenerationRequestModel {
