...
pub struct PrivateKeysResponseModel {
    ...
    #[serde(rename = "publicKeyEncryptionKeyPair", alias = "PublicKeyEncryptionKeyPair")]
...
impl PrivateKeysResponseModel {
    ...
    pub fn new(public_key_encryption_key_pair: models::PublicKeyEncryptionKeyPairResponseModel) -> PrivateKeysResponseModel {
