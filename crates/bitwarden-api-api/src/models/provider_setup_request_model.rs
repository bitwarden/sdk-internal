...
impl ProviderSetupRequestModel {
    pub fn new(name: String, billing_email: String, token: String, key: String, payment_method: models::MinimalTokenizedPaymentMethodRequest, billing_address: models::BillingAddressRequest) -> ProviderSetupRequestModel {
