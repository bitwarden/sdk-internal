...
/// Organization : An organization is an entity that allows users to share vault items and manage
/// billing, access control, and other enterprise features depending on the plan.
...
pub struct Organization {
    ...
    /// This value is HTML encoded. For display purposes use the method DisplayBusinessName()
    /// instead.
    #[serde(
        rename = "businessName",
        alias = "BusinessName",
    ...
    /// The name of the plan the organization is subscribed to. It is unclear why this is stored
    /// and what it is used for - do not use it. Use the
    /// Bit.Core.AdminConsole.Entities.Organization.PlanType instead.
    #[serde(
        rename = "plan",
        alias = "Plan",
        skip_serializing_if = "Option::is_none"
    ...
    /// The number of user seats included in the organization's subscription. NULL if the plan has
    /// no seat limit.
    #[serde(
        rename = "seats",
        alias = "Seats",
    ...
    /// The maximum number of collections the organization can create. NULL if the plan has no
    /// collection limit.
    #[serde(
    ...
    /// If true, the organization has access to the Key Connector feature, which allows SSO without
    /// master passwords.
    #[serde(
    ...
    /// If true, the organization has access to the SCIM (System for Cross-domain Identity
    /// Management) feature. This is used for automatic user provisioning.
    #[serde(
        rename = "useScim",
        alias = "UseScim",
        skip_serializing_if = "Option::is_none"
    ...
    /// If true, the organization can use Directory Connector. This is a standalone app used for
    ...
    /// If true, the organization has access to the account recovery (admin password reset)
    /// feature.
    #[serde(
    ...
    /// If true, the organization can export a license file which is used to create the
    /// organization on a self-hosted instance. It does not indicate whether this organization is
    /// self-hosted.
    #[serde(
        rename = "selfHost",
        alias = "SelfHost",
    ...
    #[serde(
        rename = "gatewayCustomerId",
        alias = "GatewayCustomerId",
        skip_serializing_if = "Option::is_none"
    )]
    pub gateway_customer_id: Option<String>,
    /// The organization's subscription ID in the payment gateway.
    #[serde(
        rename = "gatewaySubscriptionId",
        alias = "GatewaySubscriptionId",
        skip_serializing_if = "Option::is_none"
    )]
    pub gateway_subscription_id: Option<String>,
    /// A JSON blob of reference data, e.g. the signup source.
    #[serde(
        rename = "referenceData",
        alias = "ReferenceData",
        skip_serializing_if = "Option::is_none"
    )]
    pub reference_data: Option<String>,
    /// If true, the organization is active. If false, the organization is disabled and access to
    /// its vault and features are restricted.
    #[serde(
        rename = "enabled",
        alias = "Enabled",
        skip_serializing_if = "Option::is_none"
    ...
    /// The license key for the organization. Used by self-hosted instances to validate the
    /// license.
    #[serde(
        rename = "licenseKey",
        alias = "LicenseKey",
    ...
    /// A JSON blob of the organization's two-factor authentication provider configurations. Use
    /// M:Bit.Core.AdminConsole.Entities.Organization.GetTwoFactorProviders and
    /// M:Bit.Core.AdminConsole.Entities.Organization.SetTwoFactorProviders(System.Collections.
    /// Generic.Dictionary{Bit.Core.Auth.Enums.TwoFactorProviderType,Bit.Core.Auth.Models.
    /// TwoFactorProvider}) to read and write this field.
    #[serde(
    ...
    /// The maximum number of seats the organization can autoscale to. NULL if autoscaling is not
    /// limited.
    #[serde(
    ...
    #[serde(
        rename = "ownersNotifiedOfAutoscaling",
        alias = "OwnersNotifiedOfAutoscaling",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    /// If true, the organization has access to the Password Manager product. This is intended for
    /// future use if we separate Password Manager from Secrets Manager (and other products). For
    /// now, all organizations and users implicitly have access to Password Manager.
    #[serde(
    ...
    /// The number of Secrets Manager seats included in the organization's subscription. NULL if
    /// the organization does not have access to Secrets Manager.
    #[serde(
        rename = "smSeats",
        alias = "SmSeats",
        skip_serializing_if = "Option::is_none"
    ...
    /// The number of Secrets Manager machine accounts (service accounts) included in the
    /// organization's subscription. NULL if the organization does not have access to Secrets
    /// Manager.
    #[serde(
    ...
    /// The maximum number of Secrets Manager seats the organization can autoscale to. NULL if
    /// autoscaling is not limited.
    #[serde(
    ...
    /// If set to true, only owners, admins, and some custom users can delete collections. If set
    /// to false, any member can delete a collection that they have Can Manage permissions for.
    #[serde(
    ...
    /// If set to true, admins, owners, and some custom users can read/write all collections and
    /// items in the Admin Console. If set to false, users generally need collection-level
    /// permissions to read/write a collection or its items.
    #[serde(
    ...
    /// If set to true, members can only delete items when they have a Can Manage permission over
    /// the collection. If set to false, members can delete items when they have a Can Manage OR
    /// Can Edit permission over the collection.
    #[serde(
    ...
    /// If true, the organization can use the Risk Insights feature. This is a reporting feature
    /// that provides insights into the security of an organization.
    #[serde(
    ...
    /// If set to true, the organization can use the automatic user confirmation feature. This
    /// automatically confirms users in the Accepted state without requiring manual admin
    /// intervention. There are significant security risks to this and access is manually
    /// controlled by our internal teams.
    #[serde(
    ...
    /// If set to true, My Items collections will be created automatically when the Organization
    /// Data Ownership policy is enabled.
    #[serde(
        rename = "useMyItems",
        alias = "UseMyItems",
        skip_serializing_if = "Option::is_none"
    ...
    /// If set to true, the organization can generate reusable sharable invite links to invite
...
impl Organization {
    /// An organization is an entity that allows users to share vault items and manage billing,
    /// access control, and other enterprise features depending on the plan.
