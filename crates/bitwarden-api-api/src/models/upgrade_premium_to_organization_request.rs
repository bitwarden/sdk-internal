...
impl UpgradePremiumToOrganizationRequest {
    pub fn new(organization_name: String, key: String, public_key: String, encrypted_private_key: String, target_product_tier_type: models::ProductTierType, billing_address: models::CheckoutBillingAddressRequest) -> UpgradePremiumToOrganizationRequest {
