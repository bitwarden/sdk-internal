...
impl UpgradePremiumToOrganizationRequest {
    pub fn new(organization_name: String, key: String, target_product_tier_type: models::ProductTierType, billing_address: models::MinimalBillingAddressRequest) -> UpgradePremiumToOrganizationRequest {
