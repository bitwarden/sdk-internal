...
pub struct PublicKeyEncryptionKeyPairResponseModel {
    ...
    #[serde(rename = "signedPublicKey", alias = "SignedPublicKey", skip_serializing_if = "Option::is_none")]
    pub signed_public_key: Option<String>,
}

impl PublicKeyEncryptionKeyPairResponseModel {
    pub fn new(wrapped_private_key: Option<String>, public_key: Option<String>) -> PublicKeyEncryptionKeyPairResponseModel {
