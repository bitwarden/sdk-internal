...
pub struct PeopleAccessPoliciesRequestModel {
    #[serde(rename = "userAccessPolicyRequests", alias = "UserAccessPolicyRequests", skip_serializing_if = "Option::is_none")]
    pub user_access_policy_requests: Option<Vec<models::AccessPolicyRequest>>,
    #[serde(rename = "groupAccessPolicyRequests", alias = "GroupAccessPolicyRequests", skip_serializing_if = "Option::is_none")]
