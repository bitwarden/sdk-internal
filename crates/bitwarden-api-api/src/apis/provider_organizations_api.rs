...
pub trait ProviderOrganizationsApi: Send + Sync {
    ...
    ///
    ///
    async fn providers_provider_id_organizations_add_post(&self, provider_id: uuid::Uuid, provider_organization_add_request_model: Option<models::ProviderOrganizationAddRequestModel>) -> Result<(), Error>;

    /// GET /providers/{providerId}/organizations
    ///
    ///
    async fn providers_provider_id_organizations_get(&self, provider_id: uuid::Uuid) -> Result<models::ProviderOrganizationOrganizationDetailsResponseModelListResponseModel, Error>;

    /// DELETE /providers/{providerId}/organizations/{id}
    ///
    ///
    async fn providers_provider_id_organizations_id_delete(&self, provider_id: uuid::Uuid, id: uuid::Uuid) -> Result<(), Error>;

    /// POST /providers/{providerId}/organizations/{id}/delete
    ///
    ///
    async fn providers_provider_id_organizations_id_delete_post(&self, provider_id: uuid::Uuid, id: uuid::Uuid) -> Result<(), Error>;

    /// POST /providers/{providerId}/organizations
    ///
    ///
    async fn providers_provider_id_organizations_post(&self, provider_id: uuid::Uuid, provider_organization_create_request_model: Option<models::ProviderOrganizationCreateRequestModel>) -> Result<models::ProviderOrganizationResponseModel, Error>;
}
*/
