...
pub trait ProviderOrganizationsApi: Send + Sync {
    ...
    async fn providers_provider_id_organizations_add_post<'a>(
        &self,
    ...
    async fn providers_provider_id_organizations_get<'a>(
        &self,
        provider_id: uuid::Uuid,
    ) -> Result<
    ...
    async fn providers_provider_id_organizations_id_delete<'a>(
        &self,
        provider_id: uuid::Uuid,
        id: uuid::Uuid,
    ...
    async fn providers_provider_id_organizations_id_delete_post<'a>(
        &self,
        provider_id: uuid::Uuid,
        id: uuid::Uuid,
    ...
    async fn providers_provider_id_organizations_post<'a>(
        &self,
        provider_id: uuid::Uuid,
...
/// [`ProviderOrganizationsApi::providers_provider_id_organizations_add_post`]
...
/// struct for typed errors of method
/// [`ProviderOrganizationsApi::providers_provider_id_organizations_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method
/// [`ProviderOrganizationsApi::providers_provider_id_organizations_id_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method
/// [`ProviderOrganizationsApi::providers_provider_id_organizations_id_delete_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method
/// [`ProviderOrganizationsApi::providers_provider_id_organizations_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
