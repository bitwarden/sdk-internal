...
pub trait PoliciesApi: Send + Sync {
    ...
    async fn organizations_org_id_policies_get<'a>(
        &self,
        org_id: &'a str,
    ) -> Result<
    ...
    async fn organizations_org_id_policies_invited_user_get<'a>(
        &self,
        org_id: uuid::Uuid,
    ...
    async fn organizations_org_id_policies_master_password_get<'a>(
        &self,
        org_id: uuid::Uuid,
    ...
    async fn organizations_org_id_policies_token_get<'a>(
        &self,
        org_id: uuid::Uuid,
        email: Option<&'a str>,
        token: Option<&'a str>,
    ...
    async fn organizations_org_id_policies_type_get<'a>(
        &self,
        org_id: uuid::Uuid,
        r#type: i32,
    ...
    async fn organizations_org_id_policies_type_put<'a>(
        &self,
        org_id: uuid::Uuid,
...
impl PoliciesApi for PoliciesApiClient {
    ...
    ) -> Result<models::PolicyResponseModel, Error<OrganizationsOrgIdPoliciesMasterPasswordGetError>>
    {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<OrganizationsOrgIdPoliciesMasterPasswordGetError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
...
/// struct for typed errors of method [`PoliciesApi::organizations_org_id_policies_get`]
...
/// [`PoliciesApi::organizations_org_id_policies_invited_user_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method
/// [`PoliciesApi::organizations_org_id_policies_master_password_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`PoliciesApi::organizations_org_id_policies_token_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`PoliciesApi::organizations_org_id_policies_type_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`PoliciesApi::organizations_org_id_policies_type_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
