...
impl SlackIntegrationApi for SlackIntegrationApiClient {
    ...
    async fn create<'a>(&self, code: Option<&'a str>, state: Option<&'a str>) -> Result<(), Error<CreateError>> {
        ...
        let local_var_uri_str = format!("{}/organizations/integrations/slack/create", local_var_configuration.base_path);
    ...
    async fn redirect<'a>(&self, organization_id: uuid::Uuid) -> Result<(), Error<RedirectError>> {
        ...
        let local_var_uri_str = format!("{}/organizations/{organizationId}/integrations/slack/redirect", local_var_configuration.base_path, organizationId=organization_id);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
