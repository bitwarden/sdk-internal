...
pub trait SlackIntegrationApi: Send + Sync {
    ...
    ///
    ///
    async fn create_async(&self, organization_id: uuid::Uuid, code: Option<&str>) -> Result<(), Error>;

    /// GET /organizations/{organizationId}/integrations/slack/redirect
    ///
    ///
    async fn organizations_organization_id_integrations_slack_redirect_get(&self, organization_id: uuid::Uuid) -> Result<(), Error>;
}
*/
