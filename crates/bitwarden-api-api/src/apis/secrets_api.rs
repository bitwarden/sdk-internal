...
pub trait SecretsApi: Send + Sync {
    ...
    ///
    ///
    async fn organizations_organization_id_secrets_get(&self, organization_id: uuid::Uuid) -> Result<models::SecretWithProjectsListResponseModel, Error>;

    /// POST /organizations/{organizationId}/secrets
    ///
    ///
    async fn organizations_organization_id_secrets_post(&self, organization_id: uuid::Uuid, secret_create_request_model: Option<models::SecretCreateRequestModel>) -> Result<models::SecretResponseModel, Error>;

    /// GET /organizations/{organizationId}/secrets/sync
    ///
    ///
    async fn organizations_organization_id_secrets_sync_get(&self, organization_id: uuid::Uuid, last_synced_date: Option<String>) -> Result<models::SecretsSyncResponseModel, Error>;

    /// GET /projects/{projectId}/secrets
    ///
    ///
    async fn projects_project_id_secrets_get(&self, project_id: uuid::Uuid) -> Result<models::SecretWithProjectsListResponseModel, Error>;

    /// POST /secrets/delete
    ///
    ///
    async fn secrets_delete_post(&self, uuid_colon_colon_uuid: Option<Vec<uuid::Uuid>>) -> Result<models::BulkDeleteResponseModelListResponseModel, Error>;

    /// POST /secrets/get-by-ids
    ///
    ///
    async fn secrets_get_by_ids_post(&self, get_secrets_request_model: Option<models::GetSecretsRequestModel>) -> Result<models::BaseSecretResponseModelListResponseModel, Error>;

    /// GET /secrets/{id}
    ///
    ///
    async fn secrets_id_get(&self, id: uuid::Uuid) -> Result<models::SecretResponseModel, Error>;

    /// PUT /secrets/{id}
    ///
    ///
    async fn secrets_id_put(&self, id: uuid::Uuid, secret_update_request_model: Option<models::SecretUpdateRequestModel>) -> Result<models::SecretResponseModel, Error>;
}
*/
