...
pub trait AccountsBillingApi: Send + Sync {
    ...
    /// 
    async fn get_billing_history(&self, ) -> Result<models::BillingHistoryResponseModel, Error<GetBillingHistoryError>>;

    /// GET /accounts/billing/invoices
    /// 
    async fn get_invoices<'a>(&self, status: Option<&'a str>, start_after: Option<&'a str>) -> Result<(), Error<GetInvoicesError>>;

    /// GET /accounts/billing/transactions
    /// 
    async fn get_transactions<'a>(&self, start_after: Option<String>) -> Result<(), Error<GetTransactionsError>>;
}
...
impl AccountsBillingApi for AccountsBillingApiClient {
    ...
    async fn get_billing_history(&self, ) -> Result<models::BillingHistoryResponseModel, Error<GetBillingHistoryError>> {
        ...
        let local_var_uri_str = format!("{}/accounts/billing/history", local_var_configuration.base_path);
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetBillingHistoryError> = serde_json::from_str(&local_var_content).ok();
    ...
    async fn get_invoices<'a>(&self, status: Option<&'a str>, start_after: Option<&'a str>) -> Result<(), Error<GetInvoicesError>> {
        ...
        let local_var_uri_str = format!("{}/accounts/billing/invoices", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    async fn get_transactions<'a>(&self, start_after: Option<String>) -> Result<(), Error<GetTransactionsError>> {
        ...
        let local_var_uri_str = format!("{}/accounts/billing/transactions", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
