...
pub trait ServiceAccountsApi: Send + Sync {
    ...
    ///
    ///
    async fn organizations_organization_id_service_accounts_get(&self, organization_id: uuid::Uuid, include_access_to_secrets: Option<bool>) -> Result<models::ServiceAccountSecretsDetailsResponseModelListResponseModel, Error>;

    /// POST /organizations/{organizationId}/service-accounts
    ///
    ///
    async fn organizations_organization_id_service_accounts_post(&self, organization_id: uuid::Uuid, service_account_create_request_model: Option<models::ServiceAccountCreateRequestModel>) -> Result<models::ServiceAccountResponseModel, Error>;

    /// POST /service-accounts/delete
    ///
    ///
    async fn service_accounts_delete_post(&self, uuid_colon_colon_uuid: Option<Vec<uuid::Uuid>>) -> Result<models::BulkDeleteResponseModelListResponseModel, Error>;

    /// GET /service-accounts/{id}/access-tokens
    ///
    ///
    async fn service_accounts_id_access_tokens_get(&self, id: uuid::Uuid) -> Result<models::AccessTokenResponseModelListResponseModel, Error>;

    /// POST /service-accounts/{id}/access-tokens
    ///
    ///
    async fn service_accounts_id_access_tokens_post(&self, id: uuid::Uuid, access_token_create_request_model: Option<models::AccessTokenCreateRequestModel>) -> Result<models::AccessTokenCreationResponseModel, Error>;

    /// POST /service-accounts/{id}/access-tokens/revoke
    ///
    ///
    async fn service_accounts_id_access_tokens_revoke_post(&self, id: uuid::Uuid, revoke_access_tokens_request: Option<models::RevokeAccessTokensRequest>) -> Result<(), Error>;

    /// GET /service-accounts/{id}
    ///
    ///
    async fn service_accounts_id_get(&self, id: uuid::Uuid) -> Result<models::ServiceAccountResponseModel, Error>;

    /// PUT /service-accounts/{id}
    ///
    ///
    async fn service_accounts_id_put(&self, id: uuid::Uuid, service_account_update_request_model: Option<models::ServiceAccountUpdateRequestModel>) -> Result<models::ServiceAccountResponseModel, Error>;
}
*/
