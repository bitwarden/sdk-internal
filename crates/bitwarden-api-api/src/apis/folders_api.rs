...
pub trait FoldersApi: Send + Sync {
    ...
    /// POST /folders
    /// 
    async fn post<'a>(&self, folder_request_model: Option<models::FolderRequestModel>) -> Result<models::FolderResponseModel, Error>;

    /// PUT /folders/{id}
    /// 
    async fn put<'a>(&self, id: &'a str, folder_request_model: Option<models::FolderRequestModel>) -> Result<models::FolderResponseModel, Error>;
}
