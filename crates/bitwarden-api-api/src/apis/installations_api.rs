...
pub trait InstallationsApi: Send + Sync {
    ...
    /// 
    async fn get<'a>(&self, id: uuid::Uuid) -> Result<models::InstallationResponseModel, Error<GetError>>;

    /// POST /installations
    /// 
    async fn post<'a>(&self, installation_request_model: Option<models::InstallationRequestModel>) -> Result<models::InstallationResponseModel, Error<PostError>>;
}
...
impl InstallationsApi for InstallationsApiClient {
    ...
    async fn get<'a>(&self, id: uuid::Uuid) -> Result<models::InstallationResponseModel, Error<GetError>> {
        ...
        let local_var_uri_str = format!("{}/installations/{id}", local_var_configuration.base_path, id=id);
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::InstallationResponseModel`")))),
            }
        } else {
