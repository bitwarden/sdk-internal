...
impl InstallationsApi for InstallationsApiClient {
    async fn installations_id_get<'a>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<InstallationsIdGetError> =
    ...
    async fn installations_post<'a>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<InstallationsPostError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
...
/// struct for typed errors of method [`InstallationsApi::installations_id_get`]
...
/// struct for typed errors of method [`InstallationsApi::installations_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
