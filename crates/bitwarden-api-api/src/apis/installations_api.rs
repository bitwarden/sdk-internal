...
pub trait InstallationsApi: Send + Sync {
    ...
    ///
    ///
    async fn installations_id_get(&self, id: uuid::Uuid) -> Result<models::InstallationResponseModel, Error>;

    /// POST /installations
    ///
    ///
    async fn installations_post(&self, installation_request_model: Option<models::InstallationRequestModel>) -> Result<models::InstallationResponseModel, Error>;
}
*/
