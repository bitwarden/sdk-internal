...
pub trait AccountBillingVNextApi: Send + Sync {
    ...
    async fn create_portal_session<'a>(
        &self,
        email: &'a str,
        security_stamp: &'a str,
        api_key: &'a str,
        ...
        v2_upgrade_token: Option<&'a str>,
        master_password_salt: Option<&'a str>,
    ) -> Result<(), Error<CreatePortalSessionError>>;
    ...
    async fn get_applicable_discounts<'a>(
        &self,
        email: &'a str,
        security_stamp: &'a str,
        api_key: &'a str,
...
impl AccountBillingVNextApi for AccountBillingVNextApiClient {
    ...
    async fn create_portal_session<'a>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<CreatePortalSessionError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn get_applicable_discounts<'a>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetApplicableDiscountsError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
