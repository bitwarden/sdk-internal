...
/// struct for typed errors of method [`account_billing_vnext_subscription_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AccountBillingVnextSubscriptionPostError {
    UnknownValue(serde_json::Value),
}

///  This operation is defined on: [`https://github.com/bitwarden/server/blob/18aed0bd798c20abf82c64b5e17a94e483e6d23c/src/Api/Billing/Controllers/VNext/AccountBillingVNextController.cs#L41`]
...
///  This operation is defined on: [`https://github.com/bitwarden/server/blob/18aed0bd798c20abf82c64b5e17a94e483e6d23c/src/Api/Billing/Controllers/VNext/AccountBillingVNextController.cs#L31`]
...
///  This operation is defined on: [`https://github.com/bitwarden/server/blob/18aed0bd798c20abf82c64b5e17a94e483e6d23c/src/Api/Billing/Controllers/VNext/AccountBillingVNextController.cs#L53`]
...
///  This operation is defined on: [`https://github.com/bitwarden/server/blob/18aed0bd798c20abf82c64b5e17a94e483e6d23c/src/Api/Billing/Controllers/VNext/AccountBillingVNextController.cs#L63`]
...
///  This operation is defined on: [`https://github.com/bitwarden/server/blob/18aed0bd798c20abf82c64b5e17a94e483e6d23c/src/Api/Billing/Controllers/VNext/AccountBillingVNextController.cs#L75`]
pub async fn account_billing_vnext_subscription_post(
    configuration: &configuration::Configuration,
    email: &str,
    security_stamp: &str,
    api_key: &str,
    ...
    >,
) -> Result<(), Error<AccountBillingVnextSubscriptionPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_email = email;
    let p_security_stamp = security_stamp;
    let p_api_key = api_key;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AccountBillingVnextSubscriptionPostError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
