...
/// struct for typed errors of method [`account_billing_v_next_add_credit_via_bit_pay`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AccountBillingVNextAddCreditViaBitPayError {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AccountBillingVNextCreateSubscriptionError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`account_billing_v_next_get_credit`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AccountBillingVNextGetCreditError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`account_billing_v_next_get_payment_method`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`account_billing_v_next_update_payment_method`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AccountBillingVNextUpdatePaymentMethodError {
    UnknownValue(serde_json::Value),
}

pub async fn account_billing_v_next_add_credit_via_bit_pay(
...
) -> Result<(), Error<AccountBillingVNextAddCreditViaBitPayError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<AccountBillingVNextAddCreditViaBitPayError> =
...
pub async fn account_billing_v_next_create_subscription(
    configuration: &configuration::Configuration,
    email: &str,
    security_stamp: &str,
    api_key: &str,
    ...
    >,
) -> Result<(), Error<AccountBillingVNextCreateSubscriptionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_email = email;
    let p_security_stamp = security_stamp;
    let p_api_key = api_key;
    ...
    let p_last_email_change_date = last_email_change_date;
    let p_verify_devices = verify_devices;
    let p_premium_cloud_hosted_subscription_request = premium_cloud_hosted_subscription_request;
    ...
    req_builder = req_builder.json(&p_premium_cloud_hosted_subscription_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AccountBillingVNextCreateSubscriptionError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn account_billing_v_next_get_credit(
    configuration: &configuration::Configuration,
    email: &str,
    security_stamp: &str,
    api_key: &str,
    ...
    last_email_change_date: Option<String>,
    verify_devices: Option<bool>,
) -> Result<(), Error<AccountBillingVNextGetCreditError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_email = email;
    let p_security_stamp = security_stamp;
    let p_api_key = api_key;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AccountBillingVNextGetCreditError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn account_billing_v_next_get_payment_method(
    configuration: &configuration::Configuration,
    email: &str,
    security_stamp: &str,
    api_key: &str,
    ...
    last_email_change_date: Option<String>,
    verify_devices: Option<bool>,
) -> Result<(), Error<AccountBillingVNextGetPaymentMethodError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_email = email;
    let p_security_stamp = security_stamp;
    let p_api_key = api_key;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AccountBillingVNextGetPaymentMethodError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn account_billing_v_next_update_payment_method(
    configuration: &configuration::Configuration,
    email: &str,
    security_stamp: &str,
    api_key: &str,
...
) -> Result<(), Error<AccountBillingVNextUpdatePaymentMethodError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_email = email;
    let p_security_stamp = security_stamp;
    let p_api_key = api_key;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AccountBillingVNextUpdatePaymentMethodError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
