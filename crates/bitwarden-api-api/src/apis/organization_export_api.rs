...
pub trait OrganizationExportApi: Send + Sync {
    ...
    async fn organizations_organization_id_export_get<'a>(
        &self,
...
impl OrganizationExportApi for OrganizationExportApiClient {
    async fn organizations_organization_id_export_get<'a>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<OrganizationsOrganizationIdExportGetError> =
...
/// [`OrganizationExportApi::organizations_organization_id_export_get`]
