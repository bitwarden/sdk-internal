...
pub trait PushApi: Send + Sync {
    ...
    /// 
    async fn add_organization<'a>(&self, push_update_request_model: Option<models::PushUpdateRequestModel>) -> Result<(), Error<AddOrganizationError>>;

    /// POST /push/delete
    /// 
    async fn delete<'a>(&self, push_device_request_model: Option<models::PushDeviceRequestModel>) -> Result<(), Error<DeleteError>>;

    /// PUT /push/delete-organization
    /// 
    async fn delete_organization<'a>(&self, push_update_request_model: Option<models::PushUpdateRequestModel>) -> Result<(), Error<DeleteOrganizationError>>;

    /// POST /push/register
    /// 
    async fn register<'a>(&self, push_registration_request_model: Option<models::PushRegistrationRequestModel>) -> Result<(), Error<RegisterError>>;

    /// POST /push/send
    /// 
    async fn send<'a>(&self, json_element_push_send_request_model: Option<models::JsonElementPushSendRequestModel>) -> Result<(), Error<SendError>>;
}
...
impl PushApi for PushApiClient {
    ...
    async fn add_organization<'a>(&self, push_update_request_model: Option<models::PushUpdateRequestModel>) -> Result<(), Error<AddOrganizationError>> {
        ...
        let local_var_uri_str = format!("{}/push/add-organization", local_var_configuration.base_path);
    ...
    async fn delete_organization<'a>(&self, push_update_request_model: Option<models::PushUpdateRequestModel>) -> Result<(), Error<DeleteOrganizationError>> {
        ...
        let local_var_uri_str = format!("{}/push/delete-organization", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::PUT, local_var_uri_str.as_str());
