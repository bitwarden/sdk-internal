...
pub trait AccessPoliciesApi: Send + Sync {
    ...
    async fn organizations_id_access_policies_people_potential_grantees_get<'a>(
        &self,
        id: uuid::Uuid,
    ) -> Result<
    ...
    async fn organizations_id_access_policies_projects_potential_grantees_get<'a>(
        &self,
        id: uuid::Uuid,
    ) -> Result<
        models::PotentialGranteeResponseModelListResponseModel,
    ...
    async fn organizations_id_access_policies_service_accounts_potential_grantees_get<'a>(
        &self,
        id: uuid::Uuid,
    ) -> Result<
        models::PotentialGranteeResponseModelListResponseModel,
    ...
    async fn projects_id_access_policies_people_get<'a>(
        &self,
        id: uuid::Uuid,
    ) -> Result<
    ...
    async fn projects_id_access_policies_people_put<'a>(
        &self,
        id: uuid::Uuid,
    ...
    async fn projects_id_access_policies_service_accounts_get<'a>(
        &self,
        id: uuid::Uuid,
    ) -> Result<
    ...
    async fn projects_id_access_policies_service_accounts_put<'a>(
        &self,
        id: uuid::Uuid,
    ...
    async fn secrets_secret_id_access_policies_get<'a>(
        &self,
        secret_id: uuid::Uuid,
    ) -> Result<
        models::SecretAccessPoliciesResponseModel,
        Error<SecretsSecretIdAccessPoliciesGetError>,
    >;

    /// GET /service-accounts/{id}/access-policies/people
    async fn service_accounts_id_access_policies_people_get<'a>(
        &self,
        id: uuid::Uuid,
    ) -> Result<
    ...
    async fn service_accounts_id_access_policies_people_put<'a>(
        &self,
        id: uuid::Uuid,
        people_access_policies_request_model: Option<models::PeopleAccessPoliciesRequestModel>,
    ) -> Result<
    ...
    async fn service_accounts_id_granted_policies_get<'a>(
        &self,
        id: uuid::Uuid,
    ) -> Result<
    ...
    async fn service_accounts_id_granted_policies_put<'a>(
        &self,
        id: uuid::Uuid,
    ...
    > {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<
                OrganizationsIdAccessPoliciesPeoplePotentialGranteesGetError,
...
/// [`AccessPoliciesApi::organizations_id_access_policies_people_potential_grantees_get`]
...
/// struct for typed errors of method
/// [`AccessPoliciesApi::organizations_id_access_policies_projects_potential_grantees_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method
/// [`AccessPoliciesApi::organizations_id_access_policies_service_accounts_potential_grantees_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`AccessPoliciesApi::projects_id_access_policies_people_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`AccessPoliciesApi::projects_id_access_policies_people_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method
/// [`AccessPoliciesApi::projects_id_access_policies_service_accounts_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method
/// [`AccessPoliciesApi::projects_id_access_policies_service_accounts_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`AccessPoliciesApi::secrets_secret_id_access_policies_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method
/// [`AccessPoliciesApi::service_accounts_id_access_policies_people_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method
/// [`AccessPoliciesApi::service_accounts_id_access_policies_people_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method
/// [`AccessPoliciesApi::service_accounts_id_granted_policies_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method
/// [`AccessPoliciesApi::service_accounts_id_granted_policies_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
