...
/// struct for typed errors of method [`account_billing_vnext_self_host_license_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AccountBillingVnextSelfHostLicensePostError {
    UnknownValue(serde_json::Value),
}

///  This operation is defined on: [`https://github.com/bitwarden/server/blob/18aed0bd798c20abf82c64b5e17a94e483e6d23c/src/Api/Billing/Controllers/VNext/SelfHostedAccountBillingController.cs#L29`]
pub async fn account_billing_vnext_self_host_license_post(
...
) -> Result<(), Error<AccountBillingVnextSelfHostLicensePostError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<AccountBillingVnextSelfHostLicensePostError> =
