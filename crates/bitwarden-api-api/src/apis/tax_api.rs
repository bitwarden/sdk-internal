...
pub trait TaxApi: Send + Sync {
    ...
    ///
    ///
    async fn tax_preview_amount_organization_trial_post(&self, preview_tax_amount_for_organization_trial_request_body: Option<models::PreviewTaxAmountForOrganizationTrialRequestBody>) -> Result<(), Error>;
}
*/
