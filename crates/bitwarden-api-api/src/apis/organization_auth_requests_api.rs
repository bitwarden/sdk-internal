...
pub trait OrganizationAuthRequestsApi: Send + Sync {
    ...
    ///
    ///
    async fn organizations_org_id_auth_requests_deny_post(&self, org_id: uuid::Uuid, bulk_deny_admin_auth_request_request_model: Option<models::BulkDenyAdminAuthRequestRequestModel>) -> Result<(), Error>;

    /// GET /organizations/{orgId}/auth-requests
    ///
    ///
    async fn organizations_org_id_auth_requests_get(&self, org_id: uuid::Uuid) -> Result<models::PendingOrganizationAuthRequestResponseModelListResponseModel, Error>;

    /// POST /organizations/{orgId}/auth-requests
    ///
    ///
    async fn organizations_org_id_auth_requests_post(&self, org_id: uuid::Uuid, organization_auth_request_update_many_request_model: Option<Vec<models::OrganizationAuthRequestUpdateManyRequestModel>>) -> Result<(), Error>;

    /// POST /organizations/{orgId}/auth-requests/{requestId}
    ///
    ///
    async fn organizations_org_id_auth_requests_request_id_post(&self, org_id: uuid::Uuid, request_id: uuid::Uuid, admin_auth_request_update_request_model: Option<models::AdminAuthRequestUpdateRequestModel>) -> Result<(), Error>;
}
*/
