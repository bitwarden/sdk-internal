...
pub trait PhishingDomainsApi: Send + Sync {
    ...
    ///
    ///
    async fn phishing_domains_checksum_get(&self, ) -> Result<String, Error>;

    /// GET /phishing-domains
    ///
    ///
    async fn phishing_domains_get(&self, ) -> Result<Vec<String>, Error>;
}
*/
...
// #[async_trait]
impl PhishingDomainsApiClient {
    pub async fn phishing_domains_checksum_get(&self) -> Result<String, Error> {
    ...
    pub async fn phishing_domains_get(&self) -> Result<Vec<String>, Error> {
        let local_var_configuration = &self.configuration;
