...
pub trait OrganizationIntegrationConfigurationApi: Send + Sync {
    ...
    /// 
    async fn create<'a>(&self, organization_id: uuid::Uuid, integration_id: uuid::Uuid, organization_integration_configuration_request_model: Option<models::OrganizationIntegrationConfigurationRequestModel>) -> Result<models::OrganizationIntegrationConfigurationResponseModel, Error<CreateError>>;

    /// DELETE /organizations/{organizationId}/integrations/{integrationId}/configurations/{configurationId}
    /// 
    async fn delete<'a>(&self, organization_id: uuid::Uuid, integration_id: uuid::Uuid, configuration_id: uuid::Uuid) -> Result<(), Error<DeleteError>>;

    /// GET /organizations/{organizationId}/integrations/{integrationId}/configurations
    /// 
    async fn get<'a>(&self, organization_id: uuid::Uuid, integration_id: uuid::Uuid) -> Result<Vec<models::OrganizationIntegrationConfigurationResponseModel>, Error<GetError>>;

    /// PUT /organizations/{organizationId}/integrations/{integrationId}/configurations/{configurationId}
    /// 
    async fn update<'a>(&self, organization_id: uuid::Uuid, integration_id: uuid::Uuid, configuration_id: uuid::Uuid, organization_integration_configuration_request_model: Option<models::OrganizationIntegrationConfigurationRequestModel>) -> Result<models::OrganizationIntegrationConfigurationResponseModel, Error<UpdateError>>;
}
...
impl OrganizationIntegrationConfigurationApi for OrganizationIntegrationConfigurationApiClient {
    ...
    async fn create<'a>(&self, organization_id: uuid::Uuid, integration_id: uuid::Uuid, organization_integration_configuration_request_model: Option<models::OrganizationIntegrationConfigurationRequestModel>) -> Result<models::OrganizationIntegrationConfigurationResponseModel, Error<CreateError>> {
        ...
        let local_var_uri_str = format!("{}/organizations/{organizationId}/integrations/{integrationId}/configurations", local_var_configuration.base_path, organizationId=organization_id, integrationId=integration_id);
        ...
        local_var_req_builder = local_var_req_builder.json(&organization_integration_configuration_request_model);
