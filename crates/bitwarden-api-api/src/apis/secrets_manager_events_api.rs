...
pub trait SecretsManagerEventsApi: Send + Sync {
    ...
    ///
    ///
    async fn sm_events_service_accounts_service_account_id_get(&self, service_account_id: uuid::Uuid, start: Option<String>, end: Option<String>, continuation_token: Option<&str>) -> Result<models::EventResponseModelListResponseModel, Error>;
}
*/
