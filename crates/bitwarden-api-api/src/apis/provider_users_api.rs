...
pub trait ProviderUsersApi: Send + Sync {
    ...
    /// 
    async fn accept<'a>(&self, provider_id: uuid::Uuid, id: uuid::Uuid, provider_user_accept_request_model: Option<models::ProviderUserAcceptRequestModel>) -> Result<(), Error<AcceptError>>;

    /// POST /providers/{providerId}/users/confirm
    /// 
    async fn bulk_confirm<'a>(&self, provider_id: uuid::Uuid, provider_user_bulk_confirm_request_model: Option<models::ProviderUserBulkConfirmRequestModel>) -> Result<models::ProviderUserBulkResponseModelListResponseModel, Error<BulkConfirmError>>;

    /// DELETE /providers/{providerId}/users
    /// 
    async fn bulk_delete<'a>(&self, provider_id: uuid::Uuid, provider_user_bulk_request_model: Option<models::ProviderUserBulkRequestModel>) -> Result<models::ProviderUserBulkResponseModelListResponseModel, Error<BulkDeleteError>>;

    /// POST /providers/{providerId}/users/reinvite
    /// 
    async fn bulk_reinvite<'a>(&self, provider_id: uuid::Uuid, provider_user_bulk_request_model: Option<models::ProviderUserBulkRequestModel>) -> Result<models::ProviderUserBulkResponseModelListResponseModel, Error<BulkReinviteError>>;

    /// POST /providers/{providerId}/users/{id}/confirm
    /// 
    async fn confirm<'a>(&self, provider_id: uuid::Uuid, id: uuid::Uuid, provider_user_confirm_request_model: Option<models::ProviderUserConfirmRequestModel>) -> Result<(), Error<ConfirmError>>;

    /// DELETE /providers/{providerId}/users/{id}
    /// 
    async fn delete<'a>(&self, provider_id: uuid::Uuid, id: uuid::Uuid) -> Result<(), Error<DeleteError>>;

    /// GET /providers/{providerId}/users/{id}
    /// 
    async fn get<'a>(&self, provider_id: uuid::Uuid, id: uuid::Uuid) -> Result<models::ProviderUserResponseModel, Error<GetError>>;

    /// GET /providers/{providerId}/users
    /// 
    async fn get_all<'a>(&self, provider_id: uuid::Uuid) -> Result<models::ProviderUserUserDetailsResponseModelListResponseModel, Error<GetAllError>>;

    /// POST /providers/{providerId}/users/invite
    /// 
    async fn invite<'a>(&self, provider_id: uuid::Uuid, provider_user_invite_request_model: Option<models::ProviderUserInviteRequestModel>) -> Result<(), Error<InviteError>>;

    /// PUT /providers/{providerId}/users/{id}
    /// 
    async fn put<'a>(&self, provider_id: uuid::Uuid, id: uuid::Uuid, provider_user_update_request_model: Option<models::ProviderUserUpdateRequestModel>) -> Result<(), Error<PutError>>;

    /// POST /providers/{providerId}/users/{id}/reinvite
    /// 
    async fn reinvite<'a>(&self, provider_id: uuid::Uuid, id: uuid::Uuid) -> Result<(), Error<ReinviteError>>;

    /// POST /providers/{providerId}/users/public-keys
    /// 
    async fn user_public_keys<'a>(&self, provider_id: uuid::Uuid, provider_user_bulk_request_model: Option<models::ProviderUserBulkRequestModel>) -> Result<models::ProviderUserPublicKeyResponseModelListResponseModel, Error<UserPublicKeysError>>;
}
...
impl ProviderUsersApi for ProviderUsersApiClient {
    ...
    async fn accept<'a>(&self, provider_id: uuid::Uuid, id: uuid::Uuid, provider_user_accept_request_model: Option<models::ProviderUserAcceptRequestModel>) -> Result<(), Error<AcceptError>> {
        ...
        let local_var_uri_str = format!("{}/providers/{providerId}/users/{id}/accept", local_var_configuration.base_path, providerId=provider_id, id=id);
    ...
    async fn bulk_confirm<'a>(&self, provider_id: uuid::Uuid, provider_user_bulk_confirm_request_model: Option<models::ProviderUserBulkConfirmRequestModel>) -> Result<models::ProviderUserBulkResponseModelListResponseModel, Error<BulkConfirmError>> {
        ...
        let local_var_uri_str = format!("{}/providers/{providerId}/users/confirm", local_var_configuration.base_path, providerId=provider_id);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    async fn bulk_delete<'a>(&self, provider_id: uuid::Uuid, provider_user_bulk_request_model: Option<models::ProviderUserBulkRequestModel>) -> Result<models::ProviderUserBulkResponseModelListResponseModel, Error<BulkDeleteError>> {
        ...
        let local_var_uri_str = format!("{}/providers/{providerId}/users", local_var_configuration.base_path, providerId=provider_id);
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<BulkDeleteError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn bulk_reinvite<'a>(&self, provider_id: uuid::Uuid, provider_user_bulk_request_model: Option<models::ProviderUserBulkRequestModel>) -> Result<models::ProviderUserBulkResponseModelListResponseModel, Error<BulkReinviteError>> {
        ...
        let local_var_uri_str = format!("{}/providers/{providerId}/users/reinvite", local_var_configuration.base_path, providerId=provider_id);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    async fn confirm<'a>(&self, provider_id: uuid::Uuid, id: uuid::Uuid, provider_user_confirm_request_model: Option<models::ProviderUserConfirmRequestModel>) -> Result<(), Error<ConfirmError>> {
        ...
        let local_var_uri_str = format!("{}/providers/{providerId}/users/{id}/confirm", local_var_configuration.base_path, providerId=provider_id, id=id);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    async fn delete<'a>(&self, provider_id: uuid::Uuid, id: uuid::Uuid) -> Result<(), Error<DeleteError>> {
        ...
        let local_var_uri_str = format!("{}/providers/{providerId}/users/{id}", local_var_configuration.base_path, providerId=provider_id, id=id);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    async fn invite<'a>(&self, provider_id: uuid::Uuid, provider_user_invite_request_model: Option<models::ProviderUserInviteRequestModel>) -> Result<(), Error<InviteError>> {
        ...
        let local_var_uri_str = format!("{}/providers/{providerId}/users/invite", local_var_configuration.base_path, providerId=provider_id);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    async fn reinvite<'a>(&self, provider_id: uuid::Uuid, id: uuid::Uuid) -> Result<(), Error<ReinviteError>> {
        ...
        let local_var_uri_str = format!("{}/providers/{providerId}/users/{id}/reinvite", local_var_configuration.base_path, providerId=provider_id, id=id);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    async fn user_public_keys<'a>(&self, provider_id: uuid::Uuid, provider_user_bulk_request_model: Option<models::ProviderUserBulkRequestModel>) -> Result<models::ProviderUserPublicKeyResponseModelListResponseModel, Error<UserPublicKeysError>> {
        ...
        let local_var_uri_str = format!("{}/providers/{providerId}/users/public-keys", local_var_configuration.base_path, providerId=provider_id);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
