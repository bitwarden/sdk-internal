...
pub trait TrashApi: Send + Sync {
    ...
    ///
    ///
    async fn secrets_organization_id_trash_empty_post(&self, organization_id: uuid::Uuid, uuid_colon_colon_uuid: Option<Vec<uuid::Uuid>>) -> Result<(), Error>;

    /// GET /secrets/{organizationId}/trash
    ///
    ///
    async fn secrets_organization_id_trash_get(&self, organization_id: uuid::Uuid) -> Result<models::SecretWithProjectsListResponseModel, Error>;

    /// POST /secrets/{organizationId}/trash/restore
    ///
    ///
    async fn secrets_organization_id_trash_restore_post(&self, organization_id: uuid::Uuid, uuid_colon_colon_uuid: Option<Vec<uuid::Uuid>>) -> Result<(), Error>;
}
*/
