...
pub trait TrashApi: Send + Sync {
    ...
    async fn secrets_organization_id_trash_empty_post<'a>(
        &self,
    ...
    async fn secrets_organization_id_trash_get<'a>(
        &self,
        organization_id: uuid::Uuid,
    ) -> Result<
    ...
    async fn secrets_organization_id_trash_restore_post<'a>(
        &self,
        organization_id: uuid::Uuid,
        uuid_colon_colon_uuid: Option<Vec<uuid::Uuid>>,
...
/// struct for typed errors of method [`TrashApi::secrets_organization_id_trash_empty_post`]
...
/// struct for typed errors of method [`TrashApi::secrets_organization_id_trash_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`TrashApi::secrets_organization_id_trash_restore_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
