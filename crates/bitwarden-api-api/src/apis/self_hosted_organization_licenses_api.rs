...
pub trait SelfHostedOrganizationLicensesApi: Send + Sync {
    ...
    ///
    ///
    async fn organizations_licenses_self_hosted_id_post(&self, id: &str, license: std::path::PathBuf) -> Result<(), Error>;

    /// POST /organizations/licenses/self-hosted/{id}/sync
    ///
    ///
    async fn organizations_licenses_self_hosted_id_sync_post(&self, id: &str) -> Result<(), Error>;

    /// POST /organizations/licenses/self-hosted
    ///
    ///
    async fn organizations_licenses_self_hosted_post(&self, key: &str, keys_period_public_key: &str, keys_period_encrypted_private_key: &str, license: std::path::PathBuf, collection_name: Option<&str>) -> Result<models::OrganizationResponseModel, Error>;
}
*/
