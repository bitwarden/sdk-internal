...
pub trait ImportCiphersApi: Send + Sync {
    ...
    async fn ciphers_import_organization_post<'a>(
        &self,
    ...
    /// POST /ciphers/import
    async fn ciphers_import_post<'a>(
        &self,
...
/// struct for typed errors of method [`ImportCiphersApi::ciphers_import_organization_post`]
...
/// struct for typed errors of method [`ImportCiphersApi::ciphers_import_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
