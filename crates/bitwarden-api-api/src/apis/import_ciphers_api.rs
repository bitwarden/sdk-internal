...
pub trait ImportCiphersApi: Send + Sync {
    ...
    ///
    ///
    async fn ciphers_import_organization_post(&self, organization_id: Option<&str>, import_organization_ciphers_request_model: Option<models::ImportOrganizationCiphersRequestModel>) -> Result<(), Error>;

    /// POST /ciphers/import
    ///
    ///
    async fn ciphers_import_post(&self, import_ciphers_request_model: Option<models::ImportCiphersRequestModel>) -> Result<(), Error>;
}
*/
