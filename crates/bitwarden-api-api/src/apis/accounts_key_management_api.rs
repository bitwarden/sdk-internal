...
pub trait AccountsKeyManagementApi: Send + Sync {
    ...
    ///
    ///
    async fn accounts_convert_to_key_connector_post(&self, ) -> Result<(), Error>;

    /// POST /accounts/key-management/regenerate-keys
    ///
    ///
    async fn accounts_key_management_regenerate_keys_post(&self, key_regeneration_request_model: Option<models::KeyRegenerationRequestModel>) -> Result<(), Error>;

    /// POST /accounts/key-management/rotate-user-account-keys
    ///
    ///
    async fn accounts_key_management_rotate_user_account_keys_post(&self, rotate_user_account_keys_and_data_request_model: Option<models::RotateUserAccountKeysAndDataRequestModel>) -> Result<(), Error>;

    /// POST /accounts/set-key-connector-key
    ///
    ///
    async fn accounts_set_key_connector_key_post(&self, set_key_connector_key_request_model: Option<models::SetKeyConnectorKeyRequestModel>) -> Result<(), Error>;
}
*/
...
// #[async_trait]
impl AccountsKeyManagementApiClient {
    pub async fn accounts_convert_to_key_connector_post(&self) -> Result<(), Error> {
