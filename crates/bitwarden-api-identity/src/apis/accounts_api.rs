...
pub trait AccountsApi: Send + Sync {
    ...
    async fn accounts_prelogin_post<'a>(
        &self,
    ...
    async fn accounts_register_finish_post<'a>(
        &self,
    ...
    async fn accounts_register_post<'a>(
        &self,
    ...
    async fn accounts_register_send_verification_email_post<'a>(
        &self,
    ...
    async fn accounts_register_verification_email_clicked_post<'a>(
        &self,
    ...
    async fn accounts_trial_send_verification_email_post<'a>(
        &self,
    ...
    async fn accounts_webauthn_assertion_options_get<'a>(
        &self,
    ) -> Result<
...
impl AccountsApi for AccountsApiClient {
    ...
    async fn accounts_register_finish_post<'a>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::RegisterResponseModel`")))),
            }
        } else {
            let local_var_entity: Option<AccountsRegisterFinishPostError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn accounts_register_send_verification_email_post<'a>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AccountsRegisterSendVerificationEmailPostError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn accounts_register_verification_email_clicked_post<'a>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AccountsRegisterVerificationEmailClickedPostError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn accounts_trial_send_verification_email_post<'a>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AccountsTrialSendVerificationEmailPostError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
...
/// struct for typed errors of method [`AccountsApi::accounts_prelogin_post`]
...
/// struct for typed errors of method [`AccountsApi::accounts_register_finish_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`AccountsApi::accounts_register_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// [`AccountsApi::accounts_register_send_verification_email_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method
/// [`AccountsApi::accounts_register_verification_email_clicked_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
