...
use crate::{
    derive_shareable_key, enc_string::additional_data, error::UnsupportedOperation, store::backend::StoreBackend, AsymmetricCryptoKey, AsymmetricEncString, CryptoError, EncString, KeyId, KeyIds, Result, SymmetricCryptoKey
};
...
impl<Ids: KeyIds> KeyStoreContext<'_, Ids> {
    ...
    pub(crate) fn encrypt_data_with_symmetric_key(
        ...
        match key {
            ...
            SymmetricCryptoKey::XChaCha20Poly1305Key(key) => EncString::encrypt_xchacha20_poly1305(data, additional_data::AdditionalData::None, key),
        }
    }
