...
#[allow(drop_bounds)]
pub(crate) trait SliceLike<Key: KeyId>: Send + Sync + Sized + Drop {
...
pub(crate) struct SliceBackend<Key: KeyId, Slice: SliceLike<Key>> {
...
impl<Key: KeyId, Data: SliceLike<Key>> ZeroizeOnDrop for SliceBackend<Key, Data> {}

impl<Key: KeyId, Data: SliceLike<Key>> Drop for SliceBackend<Key, Data> {
    fn drop(&mut self) {
        self.clear();
    }
}

impl<Key: KeyId, Data: SliceLike<Key>> StoreBackend<Key> for SliceBackend<Key, Data> {
...
impl<Key: KeyId, Data: SliceLike<Key>> SliceBackend<Key, Data> {
...
pub(crate) mod tests {
    ...
    use super::{rust::RustBackend, *};
    use crate::{CryptoKey, KeyId};
    ...
    fn test_slice_container_insertion() {
        ...
        container.upsert(TestKey::B(10), TestKeyValue::new(110));
        assert_eq!(
        ...
        container.upsert(TestKey::C, TestKeyValue::new(1000));
        assert_eq!(
            container.get_key_data(),
            [
                Some((TestKey::B(10), TestKeyValue::new(110))),
        ...
        container.upsert(TestKey::B(20), TestKeyValue::new(210));
        assert_eq!(
            container.get_key_data(),
            [
                Some((TestKey::B(10), TestKeyValue::new(110))),
        ...
        container.upsert(TestKey::A, TestKeyValue::new(0));
        assert_eq!(
            container.get_key_data(),
            [
        ...
        container.upsert(TestKey::B(30), TestKeyValue::new(310));
        assert_eq!(
            container.get_key_data(),
            [
                Some((TestKey::A, TestKeyValue::new(0))),
        ...
        container.upsert(TestKey::A, TestKeyValue::new(1));
        assert_eq!(
            container.get_key_data(),
            [
        ...
        container.upsert(TestKey::B(20), TestKeyValue::new(211));
        assert_eq!(
            container.get_key_data(),
            [
                Some((TestKey::A, TestKeyValue::new(1))),
        ...
        container.upsert(TestKey::C, TestKeyValue::new(1001));
        assert_eq!(
            container.get_key_data(),
            [
                Some((TestKey::A, TestKeyValue::new(1))),
