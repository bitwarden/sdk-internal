...
/// [`SecretProtectedKeyEnvelope`](crate::safe::SecretProtectedKeyEnvelope), and
/// [`SymmetricKeyEnvelope`](crate::safe::SymmetricKeyEnvelope)), which all store the wrapped key
/// using the same content-format-tagged encoding.
