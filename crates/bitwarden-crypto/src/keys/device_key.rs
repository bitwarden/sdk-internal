use crate::{
    ...
    SymmetricCryptoKey, UnauthenticatedSharedKey,
};
...
pub struct TrustDeviceResponse {
    ...
    pub protected_user_key: UnauthenticatedSharedKey,
...
impl DeviceKey {
    ...
    pub fn trust_device(user_key: &SymmetricCryptoKey) -> Result<TrustDeviceResponse> {
        ...
        let protected_user_key =
            UnauthenticatedSharedKey::encapsulate_key_unsigned(user_key, &device_private_key)?;
...
mod tests {
    ...
    fn test_decrypt_user_key() {
        ...
        let protected_user_key: UnauthenticatedSharedKey = "4.".parse().unwrap();
