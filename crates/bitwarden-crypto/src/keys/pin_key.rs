use super::{
    ...
    master_key::{decrypt_user_key, encrypt_user_key}, utils::stretch_key,
};
use crate::{
    keys::key_encryptable::CryptoKey, EncString, Result, SymmetricCryptoKey,
};
...
impl PinKey {
    ...
    pub fn to_stretched_encryption_key(&self) -> Result<SymmetricCryptoKey> {
        Ok(SymmetricCryptoKey::Aes256CbcHmacKey(stretch_key(&self.0.0)?))
    }
}
