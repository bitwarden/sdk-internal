...
/// with data = [N,E], |nnnnnn|ee|, and |nnnnnnn|e| would both be valid interpretations of the concatenation of the bytes,
/// and thus may lead to the same hash for different (N,E) pairs.
/// 
