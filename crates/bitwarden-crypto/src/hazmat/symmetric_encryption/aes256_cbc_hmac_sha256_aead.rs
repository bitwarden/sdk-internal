...
//!
//! An extended construction of AES-256-CBC-HMAC-SHA256. It is used when an AES256-CBC-HMAC-SHA256 key is
//! used for authenticated encryption in the context of COSE. We keep the implementation separately intentionally.
...
impl Aead for Aes256CbcHmacSha256Aead {
    ...
    fn decrypt(
        ...
        if encrypted_bytes.len() < MAC_SIZE {
            return Err(SymmetricEncryptionError::FormatWrong);
        }
