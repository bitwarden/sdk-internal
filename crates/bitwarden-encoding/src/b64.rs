...
impl std::fmt::Display for NotB64Encoded {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str("Data isn't base64 encoded")
    }
}
...
mod tests {
    ...
    fn test_b64_serialization() {
        ...
        assert_eq!(b64.as_ref(), deserialized.as_ref());
    }
