...
pub struct Identity {
    pub title: Option<EncString<NoContext>>,
    pub first_name: Option<EncString<NoContext>>,
    pub middle_name: Option<EncString<NoContext>>,
    pub last_name: Option<EncString<NoContext>>,
    pub address1: Option<EncString<NoContext>>,
    pub address2: Option<EncString<NoContext>>,
    pub address3: Option<EncString<NoContext>>,
    pub city: Option<EncString<NoContext>>,
    pub state: Option<EncString<NoContext>>,
    pub postal_code: Option<EncString<NoContext>>,
    pub country: Option<EncString<NoContext>>,
    pub company: Option<EncString<NoContext>>,
    pub email: Option<EncString<NoContext>>,
    pub phone: Option<EncString<NoContext>>,
    pub ssn: Option<EncString<NoContext>>,
    pub username: Option<EncString<NoContext>>,
    pub passport_number: Option<EncString<NoContext>>,
    pub license_number: Option<EncString<NoContext>>,
}
