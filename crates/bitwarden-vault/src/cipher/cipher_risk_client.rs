...
mod tests {
    ...
    async fn test_calculate_password_strength_penalizes_username() {
        ...
        let strength_without_username = risk_client.calculate_password_strength("johndoe123!", None);
    ...
    async fn test_compute_risk_without_hibp() {
        ...
        let risks = risk_client.compute_risk(login_details, options).await.unwrap();
