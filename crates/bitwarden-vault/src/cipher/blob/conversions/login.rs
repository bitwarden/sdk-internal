...
mod tests {
    ...
    use crate::cipher::{
        ...
        login::{
            Fido2CredentialFullView, Fido2CredentialView, LoginUriView, LoginView, UriMatchType,
        },
    };
    ...
    fn test_login_cipher_round_trip() {
        // Create a decrypted fido2 credential view
        let fido2_view = Fido2CredentialView {
        ...
        let original = crate::CipherView {
            ...
            login: Some(LoginView {
                ...
                fido2_credentials: Some(vec![fido2_view]),
            }),
        ...
        // Fido2 credentials should round-trip as decrypted views
